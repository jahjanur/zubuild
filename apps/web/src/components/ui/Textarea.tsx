...
const textareaBase =
  'w-full rounded-xl border bg-app-surface-1 px-4 py-3 text-app-primary placeholder-app-muted transition border-[var(--border)] focus:border-[var(--border-focus)] focus:ring-2 focus:ring-[var(--accent-ring)] focus:outline-none min-h-[100px] resize-y';
