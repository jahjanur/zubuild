      ...
      >
        <div className="sticky top-0 z-10 flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-[var(--border)] bg-app-surface-2 shrink-0">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex h-12 w-12 min-h-[48px] min-w-[48px] items-center justify-center rounded-xl text-app-secondary hover:bg-white/10 hover:text-app-primary focus-visible:ring-2 focus-visible:ring-app-accent/50"
