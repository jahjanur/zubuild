          ...
          >
            <div className="flex items-start justify-between px-5 sm:px-6 py-4 border-b border-[var(--border)] shrink-0">
              ...
              <button
                type="button"
                onClick={onClose}
                className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl text-app-secondary hover:bg-[var(--hover)] hover:text-app-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--border-focus)]"
