                  ...
                  return (
                    <div key={oi.id} className="rounded-xl border border-[var(--border)] bg-app-surface-2 p-4">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-[var(--border)] bg-app-bg/50 px-4 py-3 text-app-primary text-right text-base min-h-[48px] focus:border-[var(--border-focus)] focus:ring-2 focus:ring-app-accent/20 focus:outline-none"
                      />
                        ...
                        <TableRow key={oi.id}>
                          ...
                          <TableCell className="text-right">
                            <input
                              ...
                              className="w-20 px-2 py-1.5 rounded-lg border bg-app-bg/50 border-[var(--border)] text-app-primary text-right text-sm min-h-[44px] focus:border-[var(--border-focus)] focus:ring-2 focus:ring-app-accent/20 focus:outline-none"
                            />
                          </TableCell>
                          <TableCell className="text-right">
                            {missing > 0 ? (
