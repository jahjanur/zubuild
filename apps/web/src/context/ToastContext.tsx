      ...
      {message && (
        ...
        >
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-lg text-app-secondary hover:text-app-primary hover:bg-slate-900/[0.06] focus-visible:ring-2 focus-visible:ring-[var(--border-focus)]"
            aria-label="Kapat"
          >
            ×
          </button>
